...
export const zh = {
  ...
  'focus.keepVisible': '保留可见条数 N',
  'focus.keepVisibleHint': '回复前最近 N 条运行时信息留在折叠框外',
  'focus.defaultOpen': '折叠框默认展开',
  'focus.defaultOpenHint': '运行时信息折叠框默认处于展开状态',
  'focus.summary': '折叠框摘要',
  'focus.summaryHint': '显示分类计数与工具名列表',
  'focus.strategy': '折叠策略',
  'focus.strategy.keep-recent': '保留最近 N 条',
...
export const en = {
  ...
  'focus.keepVisible': 'Visible tail N',
  'focus.keepVisibleHint': 'Keep the most recent N runtime rows outside the fold box',
  ...
  'focus.strategy.keep-recent': 'Keep recent N',
