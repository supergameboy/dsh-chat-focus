...
export const zh = {
  ...
  'chat.renderError': '渲染对话时出错，请刷新页面重试。错误：{message}',
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
  ...
  'focus.overlayHint': '在背景图片上叠加半透明层，让文字更清晰',
  'focus.overlay.none': '无遮罩',
  'focus.overlay.black20': '黑色 20%（轻微压暗）',
  'focus.overlay.black40': '黑色 40%（中等压暗）',
  'focus.overlay.black60': '黑色 60%（深度压暗）',
  'focus.overlay.white20': '白色 20%（轻微提亮）',
  'focus.overlay.white40': '白色 40%（中等提亮）',
...
export const en = {
  ...
  'chat.renderError': 'Failed to render the conversation, please refresh. Error: {message}',
  ...
  'focus.overlayHint': 'A translucent layer over the background image for clearer text',
  'focus.overlay.none': 'No overlay',
  'focus.overlay.black20': 'Black 20% (light dim)',
  'focus.overlay.black40': 'Black 40% (medium dim)',
  'focus.overlay.black60': 'Black 60% (heavy dim)',
  'focus.overlay.white20': 'White 20% (light lift)',
  'focus.overlay.white40': 'White 40% (medium lift)',
