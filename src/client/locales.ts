...
export const zh = {
  ...
  'focus.strategy.threshold': '阈值折叠（即将上线）',
  'focus.strategy.always': '全部折叠（即将上线）',
  ...
  'focus.customBgImageHint': '图片 URL 或 data URI，留空无背景图',
...
export const en = {
  ...
  'focus.strategy.threshold': 'Threshold fold (coming soon)',
  'focus.strategy.always': 'Fold all (coming soon)',
  ...
  'focus.customBgImageHint': 'Image URL or data URI; empty means none',
