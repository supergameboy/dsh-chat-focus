...
export function InputBar({
  ...
  // Whole-page file-drop intake (DeepSeek Chat behavior): the listeners and
  // the overlay live in the attachment presentation plugin's slot entry; this
  // bar only supplies the validated intake path and the acceptance gate.
